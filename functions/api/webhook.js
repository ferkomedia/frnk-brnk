  ...
  try {
    ...
    if (payload.type === 'payment_intent.succeeded') {
      ...
      const customerEmailHtml = '<!DOCTYPE html><html><head><meta charset="UTF-8"><link href="https://fonts.googleapis.com/css2?family=Andika:wght@400;700&display=swap" rel="stylesheet"></head><body style="margin:0;padding:0;background-color:' + colors.cream + ';"><table width="100%" cellpadding="0" cellspacing="0" style="background-color:' + colors.cream + ';padding:40px 20px;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 16px rgba(44,62,45,0.12);">' +
          ...
          // Faktúra tabuľka
          '<tr><td style="padding:0 40px 20px;"><table width="100%" cellpadding="0" cellspacing="0" style="font-family:Andika,Georgia,serif;font-size:14px;"><tr style="background-color:' + colors.forest + ';color:white;"><th style="padding:12px;text-align:left;border-radius:8px 0 0 0;">Položka</th><th style="padding:12px;text-align:center;">Ks</th><th style="padding:12px;text-align:right;">Cena/ks</th><th style="padding:12px;text-align:right;border-radius:0 8px 0 0;">Spolu</th></tr><tr style="background-color:' + colors.paper + ';"><td style="padding:12px;color:' + colors.text + ';">Frnk brnk do sveta</td><td style="padding:12px;text-align:center;color:' + colors.text + ';">' + quantity + '</td><td style="padding:12px;text-align:right;color:' + colors.text + ';">' + unitPrice + ' €</td><td style="padding:12px;text-align:right;color:' + colors.text + ';">' + booksTotal.toFixed(2) + ' €</td></tr><tr style="background-color:white;"><td style="padding:12px;color:' + colors.text + ';border-bottom:1px solid ' + colors.border + ';">Doručenie Packeta</td><td style="padding:12px;text-align:center;color:' + colors.text + ';border-bottom:1px solid ' + colors.border + ';">1</td><td style="padding:12px;text-align:right;color:' + colors.text + ';border-bottom:1px solid ' + colors.border + ';">' + shippingPrice.toFixed(2) + ' €</td><td style="padding:12px;text-align:right;color:' + colors.text + ';border-bottom:1px solid ' + colors.border + ';">' + shippingPrice.toFixed(2) + ' €</td></tr><tr><td colspan="3" style="padding:16px 12px;text-align:right;font-weight:bold;font-size:16px;color:' + colors.text + ';">Celkom k úhrade:</td><td style="padding:16px 12px;text-align:right;font-weight:bold;font-size:20px;color:' + colors.forest + ';">' + amount + ' €</td></tr></table></td></tr>' +
